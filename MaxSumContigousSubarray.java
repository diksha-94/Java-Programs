...
public class MaxSumContigousSubarray {
	...
	public static void combination(int[] array, int[] temp, int n, int k){
		if(k==n-1)
		{
			array[k]=0;
			addCombination(array,temp,n);
			array[k]=1;
			addCombination(array,temp,n);
			return;
		}
		array[k]=0;
		combination(array, temp, n, k+1);
		array[k]=1;
		combination(array, temp, n, k+1);
	}
	public static List<List<Integer>> resultList = new ArrayList<List<Integer>>();
	public static void addCombination(int[] str, int[] temp, int n){
